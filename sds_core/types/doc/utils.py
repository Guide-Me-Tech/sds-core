...
from sds_core.types.doc.tokens import _LOC_PREFIX, DocumentToken, TableToken

if TYPE_CHECKING:
    from sds_core.types.doc.document import TableCell, TableData
...
def otsl_parse_texts(texts: list[str], tokens: list[str]) -> tuple[list["TableCell"], list[list[str]]]:
    ...
    from sds_core.types.doc.document import TableCell
