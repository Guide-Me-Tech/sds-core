...
from sds_core.search.package import VERSION_PATTERN
from sds_core.types.base import _JSON_POINTER_REGEX
from sds_core.types.doc import BoundingBox, Size
from sds_core.types.doc.base import (
    CoordOrigin,
    ImageRefMode,
    PydanticSerCtxKey,
    round_pydantic_float,
)
from sds_core.types.doc.labels import (
    CodeLanguageLabel,
    DocItemLabel,
    GraphCellLabel,
    GraphLinkLabel,
...
from sds_core.types.doc.tokens import DocumentToken, TableToken
from sds_core.types.doc.utils import parse_otsl_table_content, relative_path
from sds_core.types.doc.webvtt import WebVTTCueIdentifier, WebVTTCueSpanStartTag, WebVTTCueSpanStartTagAnnotated
...
class TableItem(FloatingItem):
    ...
    def export_to_html(
        ...
        if doc is not None:
            from sds_core.transforms.serializer.html import HTMLDocSerializer
    ...
    def export_to_otsl(
        ...
        **kwargs: Any,
        ...
        from sds_core.transforms.serializer.doctags import DocTagsDocSerializer
...
class SdsDocument(BaseModel):
    ...
    def get_visualization(
        ...
        from sds_core.transforms.visualizer.key_value_visualizer import (
            KeyValueVisualizer,
        )
        from sds_core.transforms.visualizer.layout_visualizer import (
            LayoutVisualizer,
        )
        from sds_core.transforms.visualizer.reading_order_visualizer import (
