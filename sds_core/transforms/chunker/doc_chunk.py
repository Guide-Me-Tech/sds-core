...
from sds_core.transforms.chunker import BaseChunk, BaseMeta
from sds_core.types.doc.document import DocItem, DocumentOrigin
...
class DocMeta(BaseMeta):
    ...
    schema_name: Literal["sds_core.transforms.chunker.DocMeta"] = Field(
        default="sds_core.transforms.chunker.DocMeta",
