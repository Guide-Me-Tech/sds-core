...
from sds_core.transforms.chunker.base import BaseChunk
from sds_core.transforms.chunker.doc_chunk import _KEY_SCHEMA_NAME, DocMeta
...
class CodeDocMeta(DocMeta):
    ...
    schema_name: Literal["sds_core.transforms.chunker.CodeDocMeta"] = Field(  # type: ignore[assignment]
        default="sds_core.transforms.chunker.CodeDocMeta",
