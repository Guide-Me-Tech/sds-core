...
from sds_core.transforms.chunker.hybrid_chunker import BaseTokenizer

try:
    import tiktoken
except ImportError:
    raise RuntimeError(
        "Module requires 'chunking-openai' extra; to install, run: `pip install 'sds-core[chunking-openai]'`"
    )
