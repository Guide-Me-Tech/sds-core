...
from sds_core.types.legacy_doc.base import (
    BaseCell,
    BaseText,
    Figure,
    GlmTableCell,
...
from sds_core.types.legacy_doc.base import Table as DsSchemaTable
from sds_core.types.legacy_doc.base import TableCell as DsTableCell
from sds_core.types.legacy_doc.document import (
    CCSDocumentDescription as DsDocumentDescription,
)
from sds_core.types.legacy_doc.document import CCSFileInfoObject as DsFileInfoObject
